...
const Serve = () => {
  ...
  const data = {
    fourche: [
      ...
      { text: "Entretien d'une fourche Rock Shox - Diamètre 35", price: "151 €" },
      { text: "Entretien d'une fourche Cane Creek - Diamètre 35", price: "156 €" },
    ...
    amortisseur: [
      ...
      { text: "​Entretien d'un amortisseur simple bonbonne Cane Creek", price: "143 €" },
  ...
  return (
    <Grid>
        <Grid marginTop={2} onClick={() => router.push('/services')} display={'flex'} style={{cursor:"pointer"}} alignItems={'center'}>
            <Image src={back} width={40} height={40}/>
            <Typography color={"#a60f0c"} variant="h5">Services</Typography>
        </Grid>
      <BaseSection
        title={"Prices"}
        body={
